    ...
    internal static class WorldFactory
    {
        internal static World CreateWorld()
        {
            ...
            newWorld.AddLocation(-1, 0, "Trading Shop",
                "The shop of Oana, the trader.",
                "Trader.png");
            newWorld.LocationAt(-1, 0).TraderHere = TraderFactory.GetTraderByName("Oana");
            ...
            newWorld.AddLocation(2, 0, "Spider Forest",
                ...
                "SpiderForest.png");
            newWorld.LocationAt(2, 0).AddMonster(3, 80);
            ...
            newWorld.LocationAt(0, 2).AddMonster(1, 80);
